...
/**
 * REST controller for managing ContactNumber.
 */
@RestController
@RequestMapping("/api")
public class ContactNumberResource {
    ...
    /**
     * POST  /contact-numbers : Create a new contactNumber.
     *
     ...
     */
    @PostMapping("/contact-numbers")
    @Timed
    public ResponseEntity<ContactNumber> createContactNumber(@Valid @RequestBody ContactNumber contactNumber) throws URISyntaxException {
    ...
    /**
     * PUT  /contact-numbers : Updates an existing contactNumber.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect
     */
    @PutMapping("/contact-numbers")
    @Timed
    public ResponseEntity<ContactNumber> updateContactNumber(@Valid @RequestBody ContactNumber contactNumber) throws URISyntaxException {
        log.debug("REST request to update ContactNumber : {}", contactNumber);
        if (contactNumber.getId() == null) {
            return createContactNumber(contactNumber);
        }
        ContactNumber result = contactNumberRepository.save(contactNumber);
